...
export async function initCommand() {
    ...
    await fs.writeFile(path.join(rulesDir, "project.yml"), `name: ruledev-project
description: AI-driven development rules
targets:
  - codex
`, "utf-8");
    await fs.writeFile(path.join(ruleFilesDir, "ai-workflow.yml"), `id: ai.workflow.basic
title: AI開発の基本手順
...
`, "utf-8");
    await fs.writeFile(path.join(ruleFilesDir, "nextjs.yml"), `id: nextjs.no-client-fetch
